...
#print(dir(Avto))
#Parametrsiz va parametr bilan chiqarish
...
print(salon1()) #Parametrsiz
avto_new = Avto("Mercedes", "E200", "Silver", 2015, 80000)
salon1(avto_new) #Salonga yangi mashina qo'shamiz. parametr bilan
print(salon1())
#Natija:
    #[Avto: Oq GM Gentra, Avto: Qora Mercedes W124, Avto: Silver Toyota Carolla]
    #[Avto: Oq GM Gentra, Avto: Qora Mercedes W124, Avto: Silver Toyota Carolla, Avto: Silver Mercedes E200]
